...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Anton&family=Courier+Prime:wght@400;700&family=Barlow:wght@300;400;500;600;700&family=Playfair+Display:wght@400;700;900&family=Fraunces:opsz,wght@9..144,400;9..144,600&family=Space+Grotesk:wght@400;500;700&family=Cormorant+Garamond:wght@400;600;700&display=swap",
      },
    ],
  }),
